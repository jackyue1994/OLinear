...
do
    ...
    python -u run.py \
      ...
      --model_id ETTm2_OLinear_${seq_len}_${pred_len}_no_var_corr \
      --model $model_name \
      --data ETTm2 \
      --features M \
      --seq_len ${seq_len} \
      ...
      2>&1 | tee -a logs/orthoLinear/main_no_varcorr/orthoLinear_ETTm2_${seq_len}_${pred_len}_no_var_corr.log
done
