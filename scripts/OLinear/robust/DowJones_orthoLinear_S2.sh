...
do
    ...
    python -u run.py \
      ...
      --model_id DowJones_OLinear_${seq_len}_${pred_len}_${d_model}_robust \
      --model $model_name \
      --data custom \
      --features M \
      --seq_len ${seq_len} \
      ...
      2>&1 | tee -a logs/orthoLinear/main_no_varcorr/robust/DowJones_OLinear_${seq_len}_${pred_len}_robust.log
