...
do
    ...
    python -u run.py \
      ...
      --model_id ETTm1_OLinear_${seq_len}_${pred_len}_${learning_rate[i]}_no_var_corr \
      --model $model_name \
      --data ETTm1 \
      --features M \
      --seq_len ${seq_len} \
      ...
      2>&1 | tee -a logs/orthoLinear/main_no_varcorr/robust/orthoLinear_ETTm1_${seq_len}_${pred_len}_${learning_rate[i]}_no_var_corr.log
done
