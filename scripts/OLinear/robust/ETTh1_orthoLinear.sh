...
do
    ...
    python -u run.py \
      ...
      --model_id ETTh1_OLinear_${seq_len}_${pred_len}_robust_no_var_corr \
      --model $model_name \
      --data ETTh1 \
      --features M \
      --seq_len ${seq_len} \
      ...
      2>&1 | tee -a logs/orthoLinear/main_no_varcorr/robust/ETTh1_OLinear_${seq_len}_${pred_len}_robust_no_var_corr.log
done
