...
do
    ...
    python -u run.py \
      ...
      --model_id unemployment_OLinear_${seq_len}_${pred_len}_robust \
      --model $model_name \
      --data custom2 \
      --features M \
      --seq_len ${seq_len} \
      ...
      2>&1 | tee -a logs/orthoLinear/main_no_varcorr/robust/unemployment_OLinear_${seq_len}_${pred_len}_robust.log
