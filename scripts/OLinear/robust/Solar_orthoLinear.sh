...
do
    ...
    python -u run.py \
      ...
      --model_id orthoLinear_Solar_${seq_len}_${pred_len}_no_var_corr \
      --model $model_name \
      --data Solar \
      --features M \
      --seq_len ${seq_len} \
      ...
      2>&1 | tee -a logs/orthoLinear/main_no_varcorr/robust/Solar_OLinear_${seq_len}_${pred_len}_no_var_corr.log
