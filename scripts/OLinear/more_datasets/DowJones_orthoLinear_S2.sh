if [ ! -d "./logs/orthoLinear/main_no_varcorr/more_datasets/DowJones" ]; then
    mkdir -p ./logs/orthoLinear/main_no_varcorr/more_datasets/DowJones
fi
...
do
    ...
    python -u run.py \
      ...
      --model_id DowJones_OLinear_${seq_len}_${pred_len}_${d_model}_${lr} \
      --model $model_name \
      --data custom \
      --features M \
      --seq_len ${seq_len} \
      ...
      2>&1 | tee -a logs/orthoLinear/main_no_varcorr/more_datasets/DowJones/DowJones_OLinear_${seq_len}_${pred_len}_${d_model}_${lr}.log
