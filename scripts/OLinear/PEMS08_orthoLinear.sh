...
do
    ...
    python -u run.py \
      ...
      --model_id PEMS08_OLinear_${seq_len}_${pred_len}_no_var_corr \
      --model $model_name \
      --data PEMS \
      --features M \
      --seq_len ${seq_len} \
      ...
      2>&1 | tee -a logs/orthoLinear/main_no_varcorr/PEMS08_OLinear_${seq_len}_${pred_len}_no_var_corr.log
