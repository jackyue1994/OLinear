...
do
    ...
    python -u run.py \
      ...
      --model_id DowJones_OLinear_${seq_len}_${pred_len}_${d_models[i]}_${lrs[i]}_corr_only \
      --model $model_name \
      --data custom \
      --features M \
      --seq_len ${seq_len} \
      ...
      2>&1 | tee -a logs/orthoLinear/main_corr_only/dowjones/DowJones_OLinear_${seq_len}_${pred_len}_${d_models[i]}_${lrs[i]}_corr_only.log
