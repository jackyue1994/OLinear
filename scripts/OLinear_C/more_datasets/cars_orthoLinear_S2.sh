if [ ! -d "./logs/orthoLinear/main_corr_only/cars" ]; then
    mkdir -p ./logs/orthoLinear/main_corr_only/cars
fi
...
do
    ...
    python -u run.py \
      ...
      2>&1 | tee -a logs/orthoLinear/main_corr_only/cars/Cars_OLinear_${seq_len}_${pred_len}_${d_model}_${lr}_corr_only.log
