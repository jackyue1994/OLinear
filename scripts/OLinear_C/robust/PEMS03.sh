if [ ! -d "./logs/orthoLinear/main_corr_only/robust/PEMS03" ]; then
    mkdir -p ./logs/orthoLinear/main_corr_only/robust/PEMS03
fi
...
do
    ...
    python -u run.py \
      ...
      --model_id PEMS03_OLinear_${seq_len}_${pred_len}_robust \
      --model $model_name \
      --data PEMS \
      --features M \
      --seq_len ${seq_len} \
      ...
      2>&1 | tee -a logs/orthoLinear/main_corr_only/robust/PEMS03/PEMS03_OLinear_${seq_len}_${pred_len}_robust.log
