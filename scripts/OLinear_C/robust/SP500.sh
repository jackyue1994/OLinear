if [ ! -d "./logs/orthoLinear/main_corr_only/robust/SP500" ]; then
    mkdir -p ./logs/orthoLinear/main_corr_only/robust/SP500
fi
...
do
    ...
    python -u run.py \
      ...
      --model_id SP500_OLinear_${seq_len}_${pred_len}_robust \
      --model $model_name \
      --data custom \
      --features M \
      --seq_len ${seq_len} \
      ...
      2>&1 | tee -a logs/orthoLinear/main_corr_only/robust/SP500/SP500_OLinear_${seq_len}_${pred_len}_robust.log
