...
do
    ...
    python -u run.py \
      ...
      --q_channel_file PEMS04_COV_channel_ratio0.60.npy \
      --model_id PEMS04_OLinear_${seq_len}_${pred_len}_corr_only \
      --model $model_name \
      --data PEMS \
      --features M \
      --seq_len ${seq_len} \
      ...
      2>&1 | tee -a logs/orthoLinear/main_corr_only/PEMS04_OLinear_${seq_len}_${pred_len}_corr_only.log
