if [ ! -d "./logs/orthoLinear/ablation/var_temp/ILI" ]; then
    mkdir -p ./logs/orthoLinear/ablation/var_temp/ILI
fi
  ...
  do
    ...
    do
        ...
        python -u run.py \
          ...
          --model_id ILI_OLinear_${seq_len}_${pred_len}_var_${strs[l]}_temp_${strs[m]} \
          --model $model_name \
          --data custom \
          --features M \
          --seq_len ${seq_len} \
          ...
          2>&1 | tee -a logs/orthoLinear/ablation/var_temp/ILI/ILI_OLinear_${seq_len}_${pred_len}_var_${strs[l]}_temp_${strs[m]}.log
