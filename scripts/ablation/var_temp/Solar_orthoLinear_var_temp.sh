...
do
  ...
  do
      ...
      python -u run.py \
        ...
        --model_id orthoLinear_Solar_${seq_len}_${pred_len}_var_${var_linear_mode[l]}_temp_attnlinear \
        --model $model_name \
        --data Solar \
        --features M \
        --seq_len ${seq_len} \
        ...
        2>&1 | tee -a logs/orthoLinear/ablation/var_temp/Solar_OLinear_${seq_len}_${pred_len}_var_${var_linear_mode[l]}_temp_attnlinear.log
