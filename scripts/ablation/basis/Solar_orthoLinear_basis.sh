if [ ! -d "./logs/orthoLinear/ablation/basis/Solar" ]; then
    mkdir -p ./logs/orthoLinear/ablation/basis/Solar
fi
...
do
  ...
  do
      ...
      python -u run.py \
        ...
        --model_id Solar_${model_name}_${seq_len}_${pred_len} \
        --model $model_name \
        --data Solar \
        --features M \
        --seq_len ${seq_len} \
        ...
        2>&1 | tee -a logs/orthoLinear/ablation/basis/Solar/Solar_${model_name}_${seq_len}_${pred_len}.log
