...
do
  ...
  do
      ...
      python -u run.py \
        ...
        --model_id PEMS08_OLinear_${seq_len}_${pred_len}_${attn_var}_no_var_corr \
        --model $model_name \
        --data PEMS \
        --features M \
        --seq_len ${seq_len} \
        ...
        2>&1 | tee -a logs/orthoLinear/ablation/attn_var/PEMS08_OLinear_${seq_len}_${pred_len}_${attn_var}_no_var_corr.log
